...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /mnt/a/ROS-Jupiter-01/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /mnt/a/ROS-Jupiter-01/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /mnt/a/ROS-Jupiter-01/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'jackmin <jackmin@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/a/ROS-Jupiter-01/src/beginner_tutorials/${idir}'.  ${_report}")
    endif()
